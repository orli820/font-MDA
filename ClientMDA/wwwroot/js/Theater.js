...
北.addEventListener("click", () => {
    ...
    document.querySelector("#中部").style.display = "none"
    document.querySelector("#南部").style.display = "none"
    document.querySelector("#桃竹苗").style.display = "none"
...
桃.addEventListener("click", () => {
    ...
    document.querySelector("#中部").style.display = "none"
    document.querySelector("#南部").style.display = "none"
    document.querySelector("#桃竹苗").style.display = "inline"
    areaCH.style.display = "none"
    document.querySelector("#地區名稱").innerHTML = "桃竹苗"
})
中.addEventListener("click", () => {
    document.querySelector("#北部").style.display = "none"
    document.querySelector("#中部").style.display = "inline"
    document.querySelector("#南部").style.display = "none"
    document.querySelector("#桃竹苗").style.display = "none"
    areaCH.style.display = "none"
...
南.addEventListener("click", () => {
    document.querySelector("#北部").style.display = "none"
    document.querySelector("#中部").style.display = "none"
    document.querySelector("#南部").style.display = "inline"
    document.querySelector("#桃竹苗").style.display = "none"
    areaCH.style.display = "none"
